...
import { CombatLog, CombatEvent } from '@/lib/data';
...
export default function CombatLogPage() {
    // Mock data matching the data structure
    const logs: CombatLog[] = [
        {
            "date": "2026-03-11",
            "summary": "ウクライナ東部および中東ガザ地区での戦闘が継続中。ロシア軍によるドネツク州へのドローン攻撃が増加しており、緊張が高まっています。",
            "events": [
                {
                    "id": "cbt-001",
                    "timestamp": "2026-03-11T10:30:00Z",
                    "location": "ウクライナ・ドネツク州",
                    "region": "europe",
                    "title": "ロシア軍による大規模ドローン攻撃",
                    "content": "ドネツク州の住宅密集地に対し、計20機以上のイラン製ドローンによる攻撃が発生。エネルギーインフラの一部が損壊した模様。",
                ...
                },
                {
                    ...
                    "region": "middle_east",
                    "title": "ハマス拠点への空爆",
                    "content": "イスラエル国防軍(IDF)がガザ北部の複数の地下トンネルを空爆。ハマスの武器庫を破壊したと発表。",
                    "involved_parties": ["イスラエル軍", "ハマス"],
                    "event_type": "bombing",
                    "urgency": "medium",
                    "source_name": "Reuters",
        ...
        {
            "date": "2026-03-10",
            "summary": "黒海周辺での軍事活動が活発化しており、穀物輸出ルートの安全性が懸念されています。",
            "events": [
                {
                    "id": "cbt-003",
                    ...
                    "location": "黒海・スネーク島付近",
                    "region": "europe",
                    "title": "ロシア哨戒艦に対する自爆ドローン攻撃",
                    "content": "ウクライナ特殊部隊が水上ドローンを使用し、ロシアの哨戒艦を攻撃。深刻な損傷を与えたと主張。",
                    "involved_parties": ["ウクライナ特殊部隊", "ロシア海軍"],
                    "event_type": "clash",
                    "urgency": "high",
    ...
    return (
        <div className="fade-in">
            ...
            {/* Analysis Sidebar (Mobile Bottom) */}
